// 11주차 과제.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        if (NotepadWnd != NULL)
        {
            SendMessage(NotepadWnd, WM_CLOSE, 0, 0);

            break;
        }

        wchar_t processName1[] = L"11주차 과제.exe";
        CreateProcess(NULL, processName1, NULL, NULL, FALSE, 0, NULL, NULL, &g_si, &g_pi);
